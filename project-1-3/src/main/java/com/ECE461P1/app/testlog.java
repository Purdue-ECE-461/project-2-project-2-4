...
//    numTests++;
//    RepoHandler urlgit = new RepoHandler("https://www.github.com/octocat/Hello-World");
//    if (urlgit.getAPIUrl() != "") {
//      passedTests++;
...
//    numTests++;
//    RepoHandler urlnpm = new RepoHandler("https://www.npmjs.com/package/native-hello-world");
//    if (urlnpm.getAPIUrl() != "") {
//      passedTests++;
...
//    RepoHandler[] urls = App.parseURLS(new File("UrlTest.txt"));
//    for (RepoHandler url : urls){
...
//    ));
//    for (RepoHandler url : urls) {System.out.println(url);}
//  }
//
...
//  }
//
//  public static boolean testCorrectness(RepoHandler url){
//    numTests++;
